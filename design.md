...
<img src="images/JDK源码解析-17438505209291.png" style="zoom:75%;" />
...
![](images/原型模式-17438506049202.png)

#### 实现

原型模式的克隆分为浅克隆和深克隆。

> 浅克隆：创建一个新对象，新对象的属性和原来对象完全相同（内存地址不同），对于非基本类型属性，仍指向原有属性所指向的对象的内存地址。
>
...
<img src="images/原型模式2-17438507053143.png" style="zoom:80%;" />
...
<img src="images/原型模式3-17438507053144.png" style="zoom:80%;" />
...
![image-20250416192042443](images/image-20250416192042443.png)
